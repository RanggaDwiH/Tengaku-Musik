...
import io.github.rangga.tengaku.adapters.ViewPagerAdapter
import io.github.rangga.tengaku.databinding.ActivityMainBinding
import io.github.rangga.tengaku.fragments.Home
import io.github.rangga.tengaku.fragments.Search
import io.github.rangga.tengaku.models.MusicMode
import io.github.rangga.tengaku.models.Song
import io.github.rangga.tengaku.models.SongState
import io.github.rangga.tengaku.services.DownloadService
import io.github.rangga.tengaku.services.DownloadService.Companion.enqueueDownload
import io.github.rangga.tengaku.services.MusicService
import io.github.rangga.tengaku.services.ServiceResultReceiver
import io.github.rangga.tengaku.utils.Constants
import io.github.rangga.tengaku.utils.CustomDownloader
import io.github.rangga.tengaku.utils.MusicClientActivity
            ...
            launch(Dispatchers.Main) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    binding.bbSong.text = Html.fromHtml(
                        "${song.name} <font color=\"#FF5F55\">•</font> ${song.artist}",
