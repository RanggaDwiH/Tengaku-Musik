...
import io.github.rangga.tengaku.activities.Settings
import io.github.rangga.tengaku.adapters.SongAdapter
import io.github.rangga.tengaku.databinding.HomeBinding
import io.github.rangga.tengaku.models.CacheStatus
import io.github.rangga.tengaku.models.Format
...
import io.github.rangga.tengaku.utils.SwipeController
...
class Home : Fragment(), CoroutineScope, MusicService.MusicClient {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        RevelyGradient
            ...
            .colors(
                intArrayOf(
                    Color.parseColor("#FF5F55"),
                    Color.parseColor("#ff9655"),
                    Color.parseColor("#faea98")
                )
            )
